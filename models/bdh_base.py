...
class BDH(nn.Module):
    def __init__(self, config):
        ...
        # parameters (per layer style kept simple)
    ...
    def _layer(self, x, B, T):
        ...
        # ---- multiplicative interaction (CORE BDH) ----
    ...
    def forward(self, idx, targets=None):
        ...
        for _ in range(self.n_layer):
            if self.training:
                # recompute activations on the backward pass instead of storing
                # all n_layer copies -- needed to fit depth-24 in 6GB
